...
export default function FaqCannaDocs() {
    return (
        <div className="bg-gray-50 py-24 sm:py-32 lg:px-8 lg:py-40">
            <div className="mx-auto max-w-9xl bg-gradient-to-tr from-azul to-verde rounded-2xl">
                                        ...
                                        <>
                                            <div>
                                                <Disclosure.Button className="flex w-full items-start justify-between text-left text-white">
                                                    <span className="text-2xl font-semibold leading-7">{faq.question}</span>
